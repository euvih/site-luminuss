...
export default function DisponibilidadePage() {
  ...
  async function salvarDisponibilidade() {
    ...
    try {
      ...
      setDatasSalvas(
        [...datasSelecionadas].sort((a, b) => a.getTime() - b.getTime())
      );
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid gap-6 lg:hidden">
          ...
          <div className="rounded-3xl border border-white/10 bg-white/10 p-6 backdrop-blur">
            ...
            <div className="mt-5 grid max-h-[350px] grid-cols-2 gap-2 overflow-y-auto pr-1">
        ...
        {/* DESKTOP */}
        <div className="hidden gap-8 lg:grid lg:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-3xl border border-white/10 bg-white/10 p-4 sm:p-6 backdrop-blur">
            {loading ? (
              <p className="text-center text-white/70">Carregando calendário...</p>
            ) : (
          ...
          <div className="rounded-3xl border border-white/10 bg-white/10 p-6 backdrop-blur">
            ...
            <button
              ...
              disabled={!temAlteracao || salvando || loading}
              className={`
                mt-6 w-full rounded-xl px-5 py-3 font-semibold transition-all duration-300
                ${
                  temAlteracao
                    ? "bg-[#F4C021] text-[#061B5C] hover:opacity-90"
                    : "cursor-not-allowed border border-white/10 bg-transparent text-white/40"
